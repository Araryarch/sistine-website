  ...
  return (
    <div className="pb-20">
      ...
      <p className="mb-6 font-bold text-lg">
        Use the <code>@app.sistine()</code> decorator to register a route:
      </p>
...
def profile(user_id: int):
    return str(el.h1(f"User {user_id}"))`} 
      ...
      <h3 className="text-2xl font-black mt-12 mb-4">Query Parameters</h3>
      <p className="mb-4 font-bold text-lg">
        You can access standard URL query parameters (e.g. <code>?sort=asc&page=2</code>) directly from Streamlit's experimental API:
      </p>
...
def search():
    ...
    return str(el.div()(
      ...
      <h3 className="text-2xl font-black mt-12 mb-4">Client-side Navigation</h3>
      <p className="mt-8 mb-4 font-bold text-lg">
        Navigate via the <code>?route=</code> query parameter using Sistine's router:
      </p>
